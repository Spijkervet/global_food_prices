...
if __name__ == "__main__":
    ...
    # for x in df2.corr().values:
    #     print(list(x))
    # cluster(df, NGroups = 5, category_dic = {'sub-region': ['Sub-Saharan Africa'], COUNTRY: [], PROD : ['Rice (imported)']}, mode = 2, Alg = 0, init_mode = 2, norm = True, PCA = True)
